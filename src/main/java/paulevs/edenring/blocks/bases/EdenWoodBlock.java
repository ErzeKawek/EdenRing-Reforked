...
public class EdenWoodBlock {

    public static class EdenWoodSet {
        ...
        public EdenWoodSet(String name, MapColor barkColor, MapColor woodColor) {
            this.baseName = name;
            ...
            sign = EdenBlocks.register(
                    baseName + "_sign",
                    settings -> new Signs.EdenStandingSignBlock(
                            woodType,
                            settings.mapColor(planks.defaultMapColor())
                    ),
                    false
